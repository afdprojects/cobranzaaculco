    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('dashboard')" :active="route().current('dashboard')">
                                   <i class="bi bi-house-fill fa fa-2x" style="color:#000; font-size:19pt;"></i> Home
                                </jet-nav-link>
                            </div>

                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('configuraciones.index')" :active="route().current('configuraciones.index')">
                                   <i class="bi bi-wrench fa fa-2x" style="color:#000; font-size:19pt;"></i> Configuración
                                </jet-nav-link>
                            </div>
                        </div>
                                    ...
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                                <i class="bi bi-person-fill"></i> {{ $page.props.user.name }}
            ...
            <ul>
                ...
                <li class="has-subnav">
                    <a :href="route('catalogodecuentas.index')">
                        <i class="fa bi bi-currency-dollar fa-2x" style="color:#FFF; font-size:19pt;"></i>
                        <span class="nav-text">
                            Cuentas
                        </span>
                    </a>
                ...
                <li>
                   <a :href="route('nuevocobrodiverso.index')">
                       <i class="fa bi bi-currency-exchange fa-2x" style="color:#FFF; font-size:19pt;"></i>
                        <span class="nav-text">
                            Cobros Diversos
                        </span>
                    </a>
            ...
            <ul class="logout">
                <li>
                   <form method="POST" @submit.prevent="logout">
                             ...
                             <i class="fa bi bi-power fa-2x" style="color:#FFF; font-size:19pt;" ></i>
