...
class Create1022PadrondecomerciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('10_22_padrondecomercios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('10_22_padrondecomercios');
    }
}
