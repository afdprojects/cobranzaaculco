...
class Create0223PadrondecomerciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('02_23_padrondecomercios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('02_23_padrondecomercios');
    }
}
