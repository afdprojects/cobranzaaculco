...
class Create0422PadrondecomerciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('04_22_padrondecomercios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('04_22_padrondecomercios');
    }
}
