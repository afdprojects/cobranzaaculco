...
class Create1121PadrondecomerciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('11_21_padrondecomercios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('11_21_padrondecomercios');
    }
}
