...
class CreatePadrondecomerciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('padrondecomercios', function (Blueprint $table) {
            $table->id('id_padron_comercios');
    ...
    {
        Schema::dropIfExists('padrondecomercios');
    }
}
