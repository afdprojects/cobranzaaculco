...
class Create0922PadrondecomerciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('09_22_padrondecomercios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('09_22_padrondecomercios');
    }
}
